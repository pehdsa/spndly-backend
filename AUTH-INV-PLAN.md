Plano: Users & Invitations — Implementação Completa                                                                                            
 ...
 Implementar o sistema completo de usuários e convites conforme spec, sobre a base já existente (auth, register, invite single). Inclui CRUD de
  usuários (admin), listagem/deleção de convites, validação de token pública, batch invitations, middlewares de atividade, e ajustes de
 enum/schema.
 ...
 - app/Actions/Users/ListUsersAction.php — search (name/email ilike) + paginateFromRequest
 ...
 - app/Actions/Invitations/ListInvitationsAction.php — search (email ilike) + paginateFromRequest
